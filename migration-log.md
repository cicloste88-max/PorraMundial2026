...
[--:--] DOCS: refresh CLAUDE.md — Estado 9-jul (pipeline KO automático E2E, QF sembrados, IA line 4/4, v1.2.0 en prod) + top-3 nuevo (1 calcClassificationPoints pre-Final · 2 get-ko-crosses/ERR-99 · 3 etiqueta stadium 103/104 pre-18-jul), recortado a ≤10240B (hook verde). Sin cambios de código ni de BD en esta sesión de Code.
