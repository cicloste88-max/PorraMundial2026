...
[17:11] (lane Claude.ai, aprobado San): Backfill determinista línea IA on-demand ARG-SUI (slot 100) vía compute_match/snapshot 2, pre-kickoff, aprobado San. Motivo: paridad anti-IA entre los 4 QF (hueco por azar de navegación pre-cierre). Fila ondemand_ARG_SUI_2, sign 1, conf 67.
